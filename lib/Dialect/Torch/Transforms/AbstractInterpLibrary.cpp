...
"    torch.prim.Loop %2, %true, init() {\n"
"    ^bb0(%arg1: !torch.int):\n"
"      %3 = torch.aten.__getitem__.t %1, %arg1 : !torch.list<int>, !torch.int -> !torch.int\n"
...
"      torch.prim.Loop.condition %true, iter()\n"
"    } : (!torch.int, !torch.bool) -> ()\n"
"    %2 = torch.aten.append.t %0, %int2 : !torch.list<int>, !torch.int -> !torch.list<int>\n"
"    %3 = call @__torch__.torch.jit._shape_functions.unary(%0) : (!torch.list<int>) -> !torch.list<int>\n"
"    return %3 : !torch.list<int>\n"
"  }\n"
"  func.func @\"__torch_mlir_dtype_fn.aten.real\"(%arg0: !torch.int, %arg1: !torch.int) -> !torch.int {\n"
"    %0 = call @__torch__.complex_to_float(%arg0, %arg1) : (!torch.int, !torch.int) -> !torch.int\n"
"    return %0 : !torch.int\n"
"  }\n"
...
"    return %2 : !torch.int\n"
"  }\n"
"  func.func @\"__torch_mlir_dtype_fn.aten.imag\"(%arg0: !torch.int, %arg1: !torch.int) -> !torch.int {\n"
"    %0 = call @__torch__.complex_to_float(%arg0, %arg1) : (!torch.int, !torch.int) -> !torch.int\n"
"    return %0 : !torch.int\n"
"  }\n"
"  func.func @\"__torch_mlir_dtype_fn.aten.view_as_real\"(%arg0: !torch.int, %arg1: !torch.int) -> !torch.int {\n"
"    %0 = call @__torch__.complex_to_float(%arg0, %arg1) : (!torch.int, !torch.int) -> !torch.int\n"
"    return %0 : !torch.int\n"
"  }\n"
"  func.func @\"__torch_mlir_dtype_fn.aten.view_as_complex\"(%arg0: !torch.int, %arg1: !torch.int) -> !torch.int {\n"
"    %none = torch.constant.none\n"
"    %str = torch.constant.str \"AssertionError: Unsupported dtype\"\n"
"    %int4 = torch.constant.int 4\n"
"    %int3 = torch.constant.int 3\n"
...
"    %int6 = torch.constant.int 6\n"
"    %0 = torch.prim.Uninitialized : !torch.int\n"
"    %1 = torch.aten.eq.int %arg1, %int6 : !torch.int, !torch.int -> !torch.bool\n"
"    %2 = torch.prim.If %1 -> (!torch.int) {\n"
"      torch.prim.If.yield %int9 : !torch.int\n"
"    } else {\n"
"      %3 = torch.aten.eq.int %arg1, %int7 : !torch.int, !torch.int -> !torch.bool\n"
"      %4 = torch.prim.If %3 -> (!torch.int) {\n"
"        torch.prim.If.yield %int10 : !torch.int\n"
"      } else {\n"
"        %5 = torch.aten.eq.int %arg1, %int11 : !torch.int, !torch.int -> !torch.bool\n"
"        %6 = torch.prim.If %5 -> (!torch.bool) {\n"
"          torch.prim.If.yield %true : !torch.bool\n"
"        } else {\n"
"          %12 = torch.aten.eq.int %arg1, %int0 : !torch.int, !torch.int -> !torch.bool\n"
"          torch.prim.If.yield %12 : !torch.bool\n"
"        }\n"
"        %7 = torch.prim.If %6 -> (!torch.bool) {\n"
"          torch.prim.If.yield %true : !torch.bool\n"
"        } else {\n"
"          %12 = torch.aten.eq.int %arg1, %int1 : !torch.int, !torch.int -> !torch.bool\n"
"          torch.prim.If.yield %12 : !torch.bool\n"
"        }\n"
"        %8 = torch.prim.If %7 -> (!torch.bool) {\n"
"          torch.prim.If.yield %true : !torch.bool\n"
"        } else {\n"
"          %12 = torch.aten.eq.int %arg1, %int2 : !torch.int, !torch.int -> !torch.bool\n"
"          torch.prim.If.yield %12 : !torch.bool\n"
"        }\n"
"        %9 = torch.prim.If %8 -> (!torch.bool) {\n"
"          torch.prim.If.yield %true : !torch.bool\n"
"        } else {\n"
"          %12 = torch.aten.eq.int %arg1, %int3 : !torch.int, !torch.int -> !torch.bool\n"
"          torch.prim.If.yield %12 : !torch.bool\n"
"        }\n"
"        %10 = torch.prim.If %9 -> (!torch.bool) {\n"
"          torch.prim.If.yield %true : !torch.bool\n"
"        } else {\n"
"          %12 = torch.aten.eq.int %arg1, %int4 : !torch.int, !torch.int -> !torch.bool\n"
"          torch.prim.If.yield %12 : !torch.bool\n"
"        }\n"
"        %11 = torch.prim.If %10 -> (!torch.int) {\n"
"          torch.prim.If.yield %int9 : !torch.int\n"
